...
public class ReflectionHelperTest {
  ...
  public void privateFieldsInSuperClassShouldBeReachable() {
    ...
    assertGetFieldWithBothTypedAndNamed(
        reflectionHelper, "fnfex", FileNotFoundException.class, fileNotFoundException);
  }
  ...
  public void privateNamedFieldsInSuperClassShouldBeReachable() {
    ...
    assertGetFieldWithBothTypedAndNamed(
        new ReflectionHelper(instance, SuperClass.class),
        "fnfex",
  ...
  public void privateNamedFieldsInSuperSuperClassShouldBeReachable() {
    ...
    assertThat(
        new ReflectionHelper(instance).getField("superSneakyField").toString(), is("Find me!"));
    assertThat(instance.getSuperSneakyField(), is("Find me!"));

    assertGetFieldWithBothTypedAndNamed(
        new ReflectionHelper(instance, SuperSuperClass.class),
        "superSneakyField",
        String.class,
        "Find me!");
  }
  ...
  public void settingFinalNonStaticFieldShouldWork() {
    ...
    ReflectionHelper reflectionHelper = new ReflectionHelper(instance);
    assertGetFieldWithBothTypedAndNamed(
        reflectionHelper, "state", Thread.State.class, Thread.State.TIMED_WAITING);
  }
  ...
  public void settingFinalStaticFieldShouldWork() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            ...
            () -> reflectionHelper1.setField("FINAL_FIELD", TimeUnit.MINUTES));
    assertThat(exception.getMessage(), is("Cannot make final static field accessible"));
  }

  private void assertGetFieldWithBothTypedAndNamed(
      ReflectionHelper helper, String fieldName, Class<?> fieldType, Object expectedFieldValue) {
