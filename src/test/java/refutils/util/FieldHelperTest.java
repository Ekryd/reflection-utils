...
public class FieldHelperTest {
  ...
  public void objectInstanceShouldNotBeSetWithClassReference() throws Exception {
    ...
    expectedException.expectMessage(
        is("Cannot match Object.class type parameter, you must specify it by name"));
  ...
  public void settingFieldClassThatDontExistShouldThrowException() throws Exception {
    ...
    expectedException.expectMessage(
        is("Cannot find visible field for class java.lang.StringBuffer"));
  ...
  public void settingFieldWithWrongClassShouldThrowException() throws Exception {
    ...
    expectedException.expectMessage(
        is(
            "Can not set java.lang.Runnable field refutils.testclasses.SubClass.override to java.lang.Integer"));
  ...
  public void privateFieldsInSuperClassShouldBeModifiable() throws Exception {
    ...
    assertThat(
        getExceptionMessage(fieldHelper.getValueByType(FileNotFoundException.class)), is("Gurka"));
