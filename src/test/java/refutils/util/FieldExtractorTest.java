...
public class FieldExtractorTest {
  ...
  public void privateFieldsInSuperClassShouldNotBeVisible() throws Exception {
    ...
    assertThat(
        fieldExtractor.getAllFields(), hasItem(SubClass.class.getDeclaredField("stringPrivate2")));
    assertThat(
        fieldExtractor.getAllFields(),
        not(hasItem(SuperClass.class.getDeclaredField("stringPrivate"))));
  }
  ...
  public void protectedInheritedFieldShouldBeAvailable() throws Exception {
    FieldExtractor fieldExtractor = new FieldExtractor(SubClass.class);
    assertThat(
        fieldExtractor.getAllFields(), hasItem(SuperClass.class.getDeclaredField("intPackage")));
  }
  ...
  public void overriddenFieldShouldShowFieldInSubClass() throws Exception {
    ...
    assertThat(
        fieldExtractor.getAllFields(), not(hasItem(SuperClass.class.getDeclaredField("override"))));
  }
  ...
  public void inheritedFieldsFromStandardLibraryShouldNotBeVisible() throws Exception {
    ...
    assertThat(
        fieldExtractor.getAllFields(),
        hasItem(SubClassToThread.class.getDeclaredField("something")));
    assertThat(
        fieldExtractor.getAllFields(), hasItem(SubClassToThread.class.getDeclaredField("rex")));
